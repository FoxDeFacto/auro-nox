...
export interface ApiContactFormContactForm extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Zprava: Schema.Attribute.RichText & Schema.Attribute.Required;
  };
}
...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::event.event'> &
      Schema.Attribute.Private;
    Misto: Schema.Attribute.String & Schema.Attribute.Required;
    Nazev: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface ApiShowsModalShowsModal extends Struct.CollectionTypeSchema {
  collectionName: 'shows_modals';
  info: {
    displayName: 'ShowsModal';
    pluralName: 'shows-modals';
    singularName: 'shows-modal';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Ikona: Schema.Attribute.String & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::shows-modal.shows-modal'
    > &
      Schema.Attribute.Private;
    Popis: Schema.Attribute.RichText;
    publishedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::shows-detail.shows-detail': ApiShowsDetailShowsDetail;
      'api::shows-modal.shows-modal': ApiShowsModalShowsModal;
